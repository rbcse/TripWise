...
const Hero = () => {
    return (
        <div className='flex flex-col md:flex-row justify-center items-center gap-5 py-20 w-full px-5 md:px-10'>
            ...
            <div className='w-full md:w-[60%] lg:w-[55%] flex flex-col justify-start gap-5 text-center md:text-left'>
                ...
                <div className='flex justify-center md:justify-start'>
                    <button className='p-3 bg-[#fbc531] rounded-[10px] font-[500] cursor-pointer w-[40%] md:w-[30%] lg:w-[20%]'>
                        Try Now
                    </button>
                </div>
            </div>
