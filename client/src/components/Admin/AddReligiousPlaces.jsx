...
const AddReligiousPlacesForm = () => {
    ...
    const submitPlaceDetails = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${BACKEND_URL}/admin/add-religious-place`, formData);
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <form className="space-y-4">
                ...
                <input type="text" placeholder="Religious Place Name" className="outline-none w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#f2b50d]"  onChange={(e) => setName(e.target.value)} />
...
export default AddReligiousPlacesForm;
