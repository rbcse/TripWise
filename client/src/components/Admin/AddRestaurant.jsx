...
const AddRestaurantForm = () => {
    ...
    const submitRestaurantDetails = async (e) => {
        e.preventDefault();
        setLoading(true);
        try {
            ...
            const response = await axios.post(`${BACKEND_URL}/admin/add-restaurant`, formData);
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <form className="space-y-4">
                ...
                <input type="file" accept="application/pdf" className="outline-none w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#f2b50d]" onChange={(e) => setMenu(e.target.files[0])} />
                <input type="text" placeholder="Restaurant Name" className="outline-none w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#f2b50d]" onChange={(e) => setName(e.target.value)} />
