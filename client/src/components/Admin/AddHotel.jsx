...
const AddHotelForm = () => {
    ...
    const submitHotelDetails = async (e) => {
        e.preventDefault();
        setLoading(true); 
        try {
            ...
            const response = await axios.post(`${BACKEND_URL}/admin/add-hotel`, formData);
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <form className="space-y-4">
                ...
                <input type="text" placeholder="Hotel Name" className="outline-none w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#f2b50d]"  onChange={(e) => setName(e.target.value)} />
